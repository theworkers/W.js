...
/// W.List
// @author Ross Cairns
(function(){var root=this,W=root.W||{};typeof module!="undefined"&&module.exports?(module.exports=W,root.W=W):root.W=W,W.List=W.Object.extend({constructor:function(options){this.length=0,this.first=null,this.last=null},append:function(obj){return this.first===null?(obj.prev=obj,obj.next=obj,this.first=obj,this.last=obj):(obj.prev=this.last,obj.next=this.first,this.first.prev=obj,this.last.next=obj,this.last=obj),++this.length,this},insertAfter:function(after,obj){return obj.prev=after,obj.next=after.next,after.next.prev=obj,after.next=obj,obj.prev==this.last&&(this.last=obj),++this.length,this},remove:function(obj){return this.length>1?(obj.prev.next=obj.next,obj.next.prev=obj.prev,obj==this.first&&(this.first=obj.next),obj==this.last&&(this.last=obj.prev)):(this.first=null,this.last=null),obj.prev=null,obj.next=null,--this.length,this},at:function(index){if(index>=this.length)return!1;var obj=this.first;if(index===0)return obj;for(var i=0;i<index;++i)obj=obj.next;return obj},each:function(fn,context){var bound=context?W.bind(fn,context):fn,next=this.first;for(var i=0;i<this.length;++i)bound(next,i),next=next.next;return this}})})();